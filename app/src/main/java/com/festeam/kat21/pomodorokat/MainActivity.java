package com.festeam.kat21.pomodorokat;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tw_status = (TextView) findViewById(R.id.textView);
        tw_status.setText("Start");

        chronometer_pomodoro = (Chronometer) findViewById(R.id.chronometer10);
        chronometer_pomodoro.setText(String.format("%02d:%02d", 25, 0));

        fab_start = (FloatingActionButton) findViewById(R.id.play);
        ...
        fab_reset = (FloatingActionButton) findViewById(R.id.ret);
